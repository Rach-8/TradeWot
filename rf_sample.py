...
features, feature_cols = rf_engineer_features(spx,RF_ema_short,RF_ema_long,RF_sig_thresh)
...
buy_hold_equity = features["Close"].iloc[test_start:test_end] / features["Close"].iloc[test_start] * 10000
