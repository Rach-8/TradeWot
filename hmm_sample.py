...
while i < n:
    ...
    # =====================
    # Scaling + PCA (TRAIN ONLY)
    # =====================
    X_train_scaled, X_test_scaled, _ = fit_transform_scaler(
    ...
    vol_by_regime = (
        tmp.groupby("Regime")["SPX_21D_RealVol"]
           .mean()
    )
